...
<head>
<meta charset="UTF-8">
<title>Shopkeeper seen orders items by date</title>
<style type="text/css">
.title {
	...
	<div class="grid_container">
		...
		<div
			...
			<table class="table_content">
				...
				String start_date = request.getParameter("ent_date");
				...
				String select_query_for_table = "SELECT * FROM orders_table WHERE ordered_date = ?";
				...
				try {
					...
					select_prepst_order_table.setString(1, start_date);

					ResultSet res_set = select_prepst_order_table.executeQuery();

					if (!res_set.next()) {
						request.setAttribute("shopk_date_order_item_status", "no_item_exists");
