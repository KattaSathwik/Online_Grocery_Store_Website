...
<head>
<meta charset="UTF-8">
<title>Customer orders items</title>
<style type="text/css">
.title {
...
<body>
	...
	<div class="grid_container">
		<div class="cell" id="container_title">
			<h1 class="title">These products are ordered by <%= session.getAttribute("name") %></h1>
		</div>
		...
		<div
			...
			<table class="table_content">
				...
				try {
					...
					if (!res_set.next()) {
						request.setAttribute("cust_order_item_status", "no_item_exists");
						req_Dispatcher = request.getRequestDispatcher("person_profile.jsp");
						req_Dispatcher.forward(request, response);
					} else { 
	...
	<script type="text/javascript">
		...
		if ( order_status_code == "no_item_exists") {
			swal("Sorry", "No items we exists in the cart", "error");
		} 
