...
<head>
<meta charset="UTF-8">
<title>Shopkeeper seen orders items</title>
<style type="text/css">
.title {
	...
	<div class="grid_container">
		...
		<div
			...
			<table class="table_content">
				...
				String select_query_for_table = "SELECT * FROM orders_table WHERE ordered_date BETWEEN ? AND ?";
				...
				try {
					...
					select_prepst_order_table.setString(2, end_date);

					ResultSet res_set = select_prepst_order_table.executeQuery();

					if (!res_set.next()) {
						request.setAttribute("shopk_order_item_status", "no_item_exists");
